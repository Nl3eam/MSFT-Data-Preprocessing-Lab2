# Microsoft (MSFT) Dataset: 1986 to Present – Data Exploration, Visualization, Cleaning & Feature Engineering
...
## Dataset
* **Source:** [Microsoft (MSFT) Stock Dataset ](https://www.kaggle.com/datasets/jek1wantaufik/microsoft-msft-dataset-1986-to-present?resource=download)(Kaggle)
* **File:** MSFT_price.csv
